...
public class StringPropertyEditFactoryController extends GroupedItemEditFactoryController<StringProperty> {
	private TableViewEditFilterable<StringProperty> table;
	...
	public StringPropertyEditFactoryController(TableViewEditFilterable<StringProperty> table) {
		this.table = table;
	}
	...
	@Override
	protected TableViewEditFilterable<StringProperty> getTable() {
		return table;
	}
